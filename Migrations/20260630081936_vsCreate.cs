...
{
    /// <inheritdoc />
    public partial class vsCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "PublisherInfo",
                columns: new[] { "Id", "BrendName", "Description", "TaxCode", "TaxName" },
                values: new object[] { 1, "Como Code LLC", "Como CRM publisher information", "08284674", "Քոմո Կոդ ՍՊԸ" });

            migrationBuilder.InsertData(
                table: "PublisherBankInfo",
                columns: new[] { "Id", "BankDockName", "BankName", "Code", "PublisherInfoId" },
                values: new object[] { 1, "", "Ameriabank", "0001", 1 });

            migrationBuilder.InsertData(
                table: "PublisherMailInfo",
                columns: new[] { "Id", "FromEmail", "FromName", "Host", "Password", "Port", "PublisherInfoId", "UserName" },
                values: new object[] { 1, "comocode.info@gmail.com", "Como CRM", "smtp.gmail.com", "xojljswkfupixqig", 587, 1, "comocode.info@gmail.com" });

            migrationBuilder.InsertData(
                table: "PublisherPhoneInfo",
                columns: new[] { "Id", "PhoneNumber", "PhoneType", "PublisherId" },
                values: new object[] { 1, "+37477396770", "Mobile", 1 });

            migrationBuilder.InsertData(
                table: "PublisherBankAccountInfo",
                columns: new[] { "Id", "AccountCode", "AccountNumber", "BankInfoId", "CurrencyName" },
                values: new object[] { 1, "", "1570094723317200", 1, "AMD" });
